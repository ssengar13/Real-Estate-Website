					...
					<div class="col-lg-8">
                        <div class="row">
							...
							if(isset($_REQUEST['filter']))
							{
								...
								$sql="SELECT * FROM property WHERE (type='{$type}' AND stype='{$stype}') AND city LIKE '%$city%' order by date DESC";
                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage" style="width: 25rem; height: 18rem; object-fit: cover;">
